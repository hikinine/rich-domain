...
import { ConverterAnyBase } from "../utils/converter-any-base";
const flickrBase58 = '123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ';
const cookieBase90 = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!#$%&'()*+-./:<=>?@[]^_`{|}~";

function anyBase(srcAlphabet, dstAlphabet) {
  var converter = new ConverterAnyBase(srcAlphabet, dstAlphabet);
...
module.exports = (() => {
   ...
   *  alphabet: (string)}}
   */
  const makeConvertor: any = (toAlphabet, options) => {
